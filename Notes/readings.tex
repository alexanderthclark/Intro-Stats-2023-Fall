...
\required[Chapter~1.2]{diez2019openintro}
\indentblock{This establishes vocabulary for tabular data and variables. These readings are interchangeable.}
...
\required[Chapter~3.2.7-3.2.8]{diez2019openintro}
\indentblock{This will supplement for tree diagrams, Bayes' theorem, and some formalities.}
\required{strogatz2010chances}
\indentblock{This covers Bayes' theorem and discusses the usefulness of natural frequencies as a solution strategy.}
